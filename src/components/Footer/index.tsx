...
import  wechat  from '@/../public/img/wx.png';

const Footer: React.FC = () => {
  const defaultMessage = '阿东工作室出品';
  ...
  return (
    <DefaultFooter
      ...
      copyright={<>
        ...
        <a target={'_blank'} href={"https://beian.miit.gov.cn/"} rel="noreferrer"> 闽ICP备2023004098号-1</a>
        {" | "}
        <a target={'_blank'} href={'https://www.beian.gov.cn/portal/registerSystemInfo?recordcode=41172702000163'}
          ...
          <img src="https://img.qimuu.icu/typory/%E5%A4%87%E6%A1%88%E5%9B%BE%E6%A0%87.png"
               alt={'闽公网安备 41172702000163号'}/> 闽公网安备 41172702000163号
        </a>
      ...
      links={[
        ...
        },
        {
          ...
          href: 'https://dongapi.oss-cn-hangzhou.aliyuncs.com/wx.png',
          blankTarget: true,
        },
        {
          key: 'info',
